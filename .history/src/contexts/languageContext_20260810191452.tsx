...
const translations = {
  fr: {
    ...
    // Footer
    "footer.brand": "Infrastructure & Architect Solutions Cloud",
    "footer.contact": "Contact",
    "footer.legal": "Mentions légales",
    "footer.copyright": "© {year} Beaureilo NANTSA — Infrastructure & Architect Solutions Cloud",
    ...
    "contact.placeholder.email": "jean@gmail.com",
