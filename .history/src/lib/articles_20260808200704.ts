...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Weclood VE</strong> : gratuit, interface web compréhensible, snapshots pour les mises à jour risquées</li>
      ...
      <ul>
        ...
        <li>Coût total : 2 400 000 XAF (serveur d'occasion, switchs, câblage, UPS)</li>
