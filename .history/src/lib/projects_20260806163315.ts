...
// Nouvelle interface pour les diagrammes
...
export interface Project {
  ...
  adrs?: ADR[];
  diagrams?: Diagram[]; // ← AJOUTE CETTE LIGNE
}
...
export const projects: Project[] = [
  {
    ...
    // ✅ AJOUT DES DIAGRAMMES POUR WELOOBE
    diagrams: [
      {
        src: "/images/schemas/weloobe-architecture.png",
        alt: "Architecture Weloobe",
        title: "Vue d'ensemble de l'architecture",
        description: "Architecture multi-tenant avec Kubernetes, Ceph et PostgreSQL",
      },
      {
        src: "/images/schemas/weloobe-network.png",
        alt: "Réseau Weloobe",
        title: "Topologie réseau",
        description: "Segmentation réseau avec VLAN et HAProxy",
      },
    ],
  },
  {
    ...
    // ✅ AJOUT DES DIAGRAMMES POUR CPF MBOUO
    diagrams: [
      {
        src: "/images/schemas/cpf-mbouo-architecture.png",
        alt: "Architecture CPF Mbouo",
        title: "Architecture du système d'information",
        description: "Infrastructure de formation avec Proxmox, ZFS, pfSense et Zabbix",
      },
    ],
  },
  {
    ...
    // ✅ AJOUT DES DIAGRAMMES POUR HOTEL STENILA
    diagrams: [
      {
        src: "/images/schemas/hotel-stenila-network.png",
        alt: "Topologie réseau Hotel Stenila",
        title: "Topologie réseau segmentée",
        description: "Segmentation réseau avec VLANs pour isolation des données de paiement",
      },
    ],
  },
  {
    ...
    slug: "asait",
    challenge:
      "Permettre l'utilisation de l'IA générative en interne sans envoyer les données sensibles à l'extérieur.",
    solution:
    ...
    // ✅ AJOUT DES DIAGRAMMES POUR ASAIT
    diagrams: [
      {
        src: "/images/schemas/asait-architecture.png",
        alt: "Architecture ASAIT",
        title: "Architecture de la plateforme IA",
        description: "Déploiement de LLM locaux avec RAG et base vectorielle Qdrant",
      },
    ],
  },
];
